"""
Django settings for CatAiWebsite project.
...
SECRET_KEY = 'django-insecure-lt7xb_@iiox7t!xil$twxhe$+qc$bwy=w1ed2gn3jj%woz&_tr'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'catai/static')]
